...
(function (h) {
    ...
    function rb(a) {
        var b = a.oClasses, c = a.sTableId, d = a.oLanguage, e = a.oPreviousSearch, f = a.aanFeatures, g = '<input type="text" class="' + b.sFilterInput + '"/>', j = d.sSearch, j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g, b = h("<div/>", {
            id: !f.f ? c + "_filter" : null,
            "class": b.sFilter
        }).append(h("<div/>").append(j)), f = function () {
            var b = !this.value ?
                "" : this.value;
            b != e.sSearch && (ga(a, {
                sSearch: b,
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sUrl: "",
            sZeroRecords: "Совподений не найдено"
        },
    ...
    h.extend(m.ext.classes, {
        sTable: "dataTable",
        sNoFooter: "no-footer",
        sPageButton: "waves-effect waves-teal btn-flat",
